...
import com.mo.application.services.SamplePersonService;
...
public class CustomersView extends Div implements BeforeEnterObserver {
    ...
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "customers/%s/edit";
    ...
    public CustomersView(SamplePersonService samplePersonService) {
