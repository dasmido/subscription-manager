...
import com.mo.application.data.SampleAddress;
import com.mo.application.services.SampleAddressService;
...
@PageTitle("Serials")
@Route(value = "serials/:sampleAddressID?/:action?(edit)", layout = MainLayout.class)
@RolesAllowed("ADMIN")
public class SerialsView extends Div implements BeforeEnterObserver {

    private final String SAMPLEADDRESS_ID = "sampleAddressID";
    private final String SAMPLEADDRESS_EDIT_ROUTE_TEMPLATE = "serials/%s/edit";
    ...
    public SerialsView(SampleAddressService sampleAddressService) {
        this.sampleAddressService = sampleAddressService;
        addClassNames("serials-view");
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (sampleAddressId.isPresent()) {
            ...
            if (sampleAddressFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(SerialsView.class);
            }
        }
    }
